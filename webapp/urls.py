...
urlpatterns = [
    ...
    path('custom_courses/<int:topic_id>/topic', views.custom_topic_detail, name='custom_topic_detail'),
    ...
    path("all_custom_topics", views.listCustomTopics, name="listcustom_topics"),
    path("create_custom_topics", views.create_custom_topic, name="create_custom_topics"),
